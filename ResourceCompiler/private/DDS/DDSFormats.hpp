...
public:
  ...
  DDS_NO_DISCARD std::size_t size() const noexcept { return _size; }
  DDS_NO_DISCARD std::size_t size_bytes() const noexcept { return _size * sizeof(T); }
  DDS_NO_DISCARD T* data() const noexcept { return _data; }
};
#endif
