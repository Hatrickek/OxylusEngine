...
vk::Instance ContextUtils::CreateInstance(
  ...
  const vk::ApplicationInfo applicationInfo(appName.c_str(), 1,
                                            engineName.c_str(), 1, apiVersion);
...
vk::Device ContextUtils::CreateDevice(
    const vk::PhysicalDevice &physicalDevice, uint32_t queueFamilyIndex,
  ...
  vk::DeviceQueueCreateInfo deviceQueueCreateInfo({}, queueFamilyIndex, 1,
                                                  &queuePriority);
  const vk::DeviceCreateInfo deviceCreateInfo({}, deviceQueueCreateInfo, {},
                                              enabledExtensions,
